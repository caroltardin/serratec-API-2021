...
public class ProdutoController {
		...
		@GetMapping
		@ApiOperation(value = "Lista todos os produtos", notes = "Listagem com todos os produtos")
		@ApiResponses(value = {
		...
		public ResponseEntity<Produto> inserir(@Valid @RequestBody Produto produto, UriComponentsBuilder b) {
			UriComponents uriComponents = b.path("/produtos/{id}").buildAndExpand(produto.getId_produto());
			return ResponseEntity.created(uriComponents.toUri()).body(produtoService.inserir(produto));
		}
